...
class ResidentialCarInfo extends StatelessWidget {
  final RegisteredCar registeredCar;
  const ResidentialCarInfo({super.key, required this.registeredCar});
        ...
        children: [
          ...
          Align(
            ...
            child: Container(
              ...
              child: Text(registeredCar.registeredCarType.name, style: TextStyle(color: primaryColor)),
            ),
          )
        ],
      ),
